...
public class WeatherPane extends JPanel {
	...
	private Object showWeather(String description, int idx) {
		...
		ImageIcon sun = new ImageIcon(("src/weather/sunny.png"));//기본 이미지
		...
		if (description.equals("clear sky")) {
			ImageIcon sunny = new ImageIcon(("src/weather/sunny.png"));
			img = sunny.getImage();
		}
		if (description.equals("light rain")) {
			ImageIcon lightRain = new ImageIcon(("src/weather/light-rain.png"));
			img = lightRain.getImage();
		}
		if (description.equals("moderate rain")) {
			ImageIcon modRain = new ImageIcon(("src/weather/moderate-rain.png"));
			img = modRain.getImage();
		}
		if (description.equals("overcast clouds")) {
			ImageIcon ovCloud = new ImageIcon(("src/weather/cloudy&sunny.png"));
			img = ovCloud.getImage();
		}
		if (description.equals("scattered clouds")) {
			ImageIcon cloud = new ImageIcon("src/weather/cloudy.png");
			img = cloud.getImage();
		}
		if (description.equals("heavy intensity rain")) {
			ImageIcon heavyRain = new ImageIcon(("src/weather/heavyrain.png"));
